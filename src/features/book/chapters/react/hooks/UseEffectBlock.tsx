...
export function UseEffectBlock() {
    return (
        <>
            ...
            <CodeBlock code={`useEffect(() => {}, [])        // 1 раз (mount)
...
`}/>
            <p>❌ А внутри <code>fetchData</code> используется <code>props</code> или <code>state</code></p>
            <p>👉 <b>stale closure</b> — эффект видит старые значения</p>
            <hr/>
